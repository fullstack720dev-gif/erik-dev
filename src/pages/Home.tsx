...
const Home = () => {
	...
	const email = 'erikwang1992@outlook.com';
	...
	return (
		<div className="min-h-screen flex items-center justify-center px-4 mt-7 sm:mt-0 md:mt-3 lg:mt-5">
			<div className="text-center relative z-10 max-w-4xl mx-auto">
				...
				>
					I build scalable web and mobile products powered by modern full-stack architecture, AI automation, and clean user experiences. I help startups and businesses turn ideas into reliable, production-ready software.
				</motion.p>
