	...
	const educationData = [
		{
			...
			description: "During my graduate studies at the University of Texas at Dallas, I strengthened my expertise in advanced software engineering, scalable backend systems, algorithms, databases, cloud-based applications, and distributed computing. This program helped me build a strong technical foundation for designing production-grade web, mobile, and backend platforms."
		},
		{
			school: "University of Texas at Dallas",
			location: "Richardson, Texas, United States",
			...
			description: "My undergraduate studies in Computer Science gave me a strong foundation in programming, data structures, algorithms, operating systems, databases, networking, and object-oriented software development. This academic background shaped my engineering mindset and prepared me to build reliable full-stack, web, mobile, and backend applications."
		}
	];
