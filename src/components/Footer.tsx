				...
				<div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-12">
					...
					<div className="space-y-4">
						<Link href="/" className="flex items-center space-x-3">
							...
							<span className="text-xl font-bold text-white">Prometheus</span>
						</Link>
						<p className="text-sm text-gray-400">
							Software Developer based in Houston, TX, US.
						</p>
					</div>
					...
					<div className="space-y-4">
						...
						<ul className="space-y-3">
							<li>
								<a href="mailto:erikwang1992@outlook.com" className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2">
									<Mail className="w-4 h-4" />
									erikwang1992@outlook.com
								</a>
							</li>
							<li>
								<a
									href="tel:+1 (713) 570-6397"
